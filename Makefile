...
# Core subsystems
SOURCE  += allocator.c timer.c panic.c drivers.c i2c.c output.c main.c menu.c sysinfo.c video.c input.c elf.c elf_asm.S linux.c dol.c log.c cleanup.c config.c
...
# Bus drivers
SOURCE  += drivers/exi.c drivers/hollywood_gpio_i2c.c
