...
ASFLAGS :=
CFLAGS  := -mregnames -mcpu=750 -meabi -Iinclude -ggdb3 -nostdinc -ffreestanding -fno-pic -fno-pie -fno-jump-tables -fno-omit-frame-pointer -fstack-protector-strong '-DVERSION="$(VERSION)"' -D__BSD_VISIBLE=1
#CFLAGS  += -DDO_TRACE
...
SOURCE  += drivers/hollywood_gpio.c drivers/exi.c drivers/usbgecko.c drivers/vi.c drivers/latte_framebuffer.c drivers/drc_ipc_text.c drivers/hollywood_sdmmc.c drivers/si.c drivers/reset_switch.c
