...
SOURCE  += allocator.c timer.c panic.c init.c drivers.c output.c main.c menu.c video.c input.c elf.c elf_asm.S log.c platOps_debug.c tiny_usbgecko.c exception.c exception_2200.S irq.c irq_asm.S
